...
{
    /// <inheritdoc />
    public partial class AddCommunityRequest : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommunityRequests", x => new { x.UserId, x.CommunityId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_CommunityRequests_Users_UserId",
                        column: x => x.UserId,
